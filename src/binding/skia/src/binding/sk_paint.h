...
void SkPaint_refShader(int sk_shader_key_out, SkPaint *paint);
void SkPaint_setShader(int sk_shader_key_in, SkPaint *paint);
SkColorFilter * SkPaint_getColorFilter(SkPaint *paint);
void SkPaint_refColorFilter(int sk_color_filter_key_out, SkPaint *paint);
void SkPaint_setColorFilter(int sk_color_filter_key_in, SkPaint *paint);
void SkPaint_asBlendMode(int sk_blend_mode_key_out, SkPaint *paint);
