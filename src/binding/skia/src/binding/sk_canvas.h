...
void SkCanvas_drawImage_2(int sk_image_key_in, SkCanvas *canvas, SkScalar x, SkScalar y, const SkSamplingOptions *sampling, const SkPaint *paint);
...
void SkCanvas_drawImageRect(int sk_image_key_in, SkCanvas *canvas, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint);
void SkCanvas_drawImageRect_2(int sk_image_key_in, SkCanvas *canvas, const SkRect *src, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint);
...
void SkCanvas_drawPicture_2(int sk_picture_key_in, SkCanvas *canvas, const SkMatrix *matrix, const SkPaint *paint);
...
void SkCanvas_drawTextBlob(int sk_text_blob_key_in, SkCanvas *canvas, SkScalar x, SkScalar y, const SkPaint *paint);
