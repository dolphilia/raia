...
gr_backend_texture_t GrDirectContext_createCompressedBackendTexture(GrDirectContext *direct_context, int width, int height, const GrBackendFormat *format, const SkColor4f *color, skgpu::Mipmapped mipmapped, GrProtected isProtected, GrGpuFinishedProc finishedProc, GrGpuFinishedContext finishedContext);
gr_backend_texture_t GrDirectContext_createCompressedBackendTexture_2(GrDirectContext *direct_context, int width, int height, SkTextureCompressionType type, const SkColor4f *color, skgpu::Mipmapped mipmapped, GrProtected isProtected, GrGpuFinishedProc finishedProc, GrGpuFinishedContext finishedContext);
gr_backend_texture_t GrDirectContext_createCompressedBackendTexture_3(GrDirectContext *direct_context, int width, int height, const GrBackendFormat *format, const void *data, size_t dataSize, skgpu::Mipmapped mipmapped, GrProtected isProtected, GrGpuFinishedProc finishedProc, GrGpuFinishedContext finishedContext);
gr_backend_texture_t GrDirectContext_createCompressedBackendTexture_4(GrDirectContext *direct_context, int width, int height, SkTextureCompressionType type, const void *data, size_t dataSize, skgpu::Mipmapped mipmapped, GrProtected isProtected, GrGpuFinishedProc finishedProc, GrGpuFinishedContext finishedContext);
