...
void SkRuntimeEffect_makeShader(const char *sk_shader_key_out, const char *sk_data_key_in, SkRuntimeEffect *runtime_effect, sk_sp<SkShader> children[], size_t childCount, const SkMatrix *localMatrix) {
...
void
SkRuntimeEffect_makeShader_2(const char *sk_shader_key_out, const char *sk_data_key_in,
                             const char *sk_runtime_effect_child_ptr_key_in, SkRuntimeEffect *runtime_effect,
...
void SkRuntimeEffect_makeColorFilter(const char *sk_color_filter_key_out, const char *sk_data_key_in,
...
void SkRuntimeEffect_makeColorFilter_2(const char *sk_color_filter_key_out, const char *sk_data_key_in,
...
void SkRuntimeEffect_makeColorFilter_3(const char *sk_color_filter_key_out, const char *sk_data_key_in,
                                       const char *sk_runtime_effect_child_ptr_key_in,
                                       SkRuntimeEffect *runtime_effect) {
...
void
SkRuntimeEffect_makeBlender(const char *sk_blender_key_out, const char *sk_data_key_in,
                            const char *sk_runtime_effect_child_ptr_key_in, SkRuntimeEffect *runtime_effect) {
...
void SkRuntimeEffect_MakeForColorFilter(const char *sk_runtime_effect_result_key_out, const char *sk_string_key_in,
...
void SkRuntimeEffect_MakeForColorFilter_2(const char *sk_runtime_effect_result_key_out, const char *sk_string_key_in) {
...
void SkRuntimeEffect_MakeForShader(const char *sk_runtime_effect_result_key_out, const char *sk_string_key_in, const SkRuntimeEffect::Options *options) {
...
void SkRuntimeEffect_MakeForShader_2(const char *sk_runtime_effect_result_key_out, const char *sk_string_key_in) {
...
void SkRuntimeEffect_MakeForBlender(const char *sk_runtime_effect_result_key_out, const char *sk_string_key_in, const SkRuntimeEffect::Options *options) {
...
void SkRuntimeEffect_MakeForBlender_2(const char *sk_runtime_effect_result_key_out, const char *sk_string_key_in) {
...
void SkRuntimeEffect_MakeTraced(const char *sk_runtime_effect_traced_shader_key_out, const char *sk_shader_key_in,
