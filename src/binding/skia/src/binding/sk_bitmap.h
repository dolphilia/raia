...
void SkBitmap_bounds(const char *sk_i_rect_key_out, SkBitmap *bitmap);
...
void SkBitmap_getSubset(const char *sk_i_rect_key_out, SkBitmap *bitmap);
int SkBitmap_height(SkBitmap *bitmap);
void SkBitmap_info(const char *sk_image_info_key_out, SkBitmap *bitmap);
...
void SkBitmap_pixmap(const char *sk_pixmap_key_out, SkBitmap *bitmap);
