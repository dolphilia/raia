...
int SkBitmap_bounds(SkBitmap *bitmap);
...
int SkBitmap_getSubset(SkBitmap *bitmap);
...
int SkBitmap_makeShader(SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm);
int SkBitmap_makeShader_2(SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm);
int SkBitmap_makeShader_3(SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *localMatrix);
int SkBitmap_makeShader_4(SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *lm);
