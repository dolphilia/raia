...
void SkBitmap_asImage(int sk_image_key_out, SkBitmap *bitmap);
void SkBitmap_bounds(int sk_i_rect_key_out, SkBitmap *bitmap);
...
void SkBitmap_getSubset(int sk_i_rect_key_out, SkBitmap *bitmap);
int SkBitmap_height(SkBitmap *bitmap);
void SkBitmap_info(int sk_image_info_key_out, SkBitmap *bitmap);
...
void SkBitmap_makeShader(int sk_shader_key_out, SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm);
void SkBitmap_makeShader_2(int sk_shader_key_out, SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm);
void SkBitmap_makeShader_3(int sk_shader_key_out, SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *localMatrix);
void SkBitmap_makeShader_4(int sk_shader_key_out, SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *lm);
...
void SkBitmap_pixmap(int sk_pixmap_key_out, SkBitmap *bitmap);
...
void SkBitmap_refColorSpace(int sk_color_space_key_out, SkBitmap *bitmap);
