extension Skia {
    protocol SkV3Protocol {
        var pointer: SkV3MutablePointer? { get set }
        var handle: sk_v3_t { get set }
        // deinit // void SkV3_delete(void *v3); // (SkV3 *v3)
        init(pointer: SkV3MutablePointer?, handle: sk_v3_t)
        // Static Methods
        static func Dot(a: SkV3, b: SkV3) -> Float // float SkV3_Dot(const void *a, const void *b); // (const SkV3 *a, const SkV3 *b) -> SkScalar
        static func Cross(a: SkV3, b: SkV3) -> SkV3 // int SkV3_Cross(const void *a, const void *b); // (const SkV3 *a, const SkV3 *b) -> sk_v3_t
        static func Normalize(v: SkV3) -> SkV3 // int SkV3_Normalize(const void *v); // (const SkV3 *v) -> sk_v3_t
        // Methods
        ...
        func dot(v: SkV3) -> Float // float SkV3_dot(void *v3, const void *v); // (SkV3 *v3, const SkV3 *v) -> SkScalar
        func cross(v: SkV3) -> SkV3 // int SkV3_cross(void *v3, const void *v); // (SkV3 *v3, const SkV3 *v) -> sk_v3_t
        func normalize() -> SkV3 // int SkV3_normalize(void *v3); // (SkV3 *v3) -> sk_v3_t
    ...
    class SkV3 : SkV3Protocol {
        public var pointer: SkV3MutablePointer?
        ...
        required init(pointer: SkV3MutablePointer?, handle: sk_v3_t) {
        ...
        static func Dot(a: SkV3, b: SkV3) -> Float {
            return SkV3_Dot(a.pointer, b.pointer)
        }

        static func Cross(a: SkV3, b: SkV3) -> SkV3 {
        ...
        static func Normalize(v: SkV3) -> SkV3 {
        ...
        func dot(v: SkV3) -> Float {
            return SkV3_dot(self.pointer, v.pointer)
        }

        func cross(v: SkV3) -> SkV3 {
