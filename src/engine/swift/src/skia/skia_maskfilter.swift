extension Skia {
    class SkMaskFilter {
        public var pointer: SkMaskFilterMutablePointer?
        public var handle: sk_mask_filter_t = -1
        // void SkMaskFilter_delete(void *maskFilter); // (SkMaskFilter *maskFilter)
        func delete() {
            SkMaskFilter_delete(self.pointer)
        }
        ...
        init(pointer: SkMaskFilterMutablePointer?, handle: sk_mask_filter_t) {
