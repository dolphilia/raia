extension Skia {
    ...
    protocol SkRegionProtocol {
        ...
        func getBounds() -> SkIRect // const void *SkRegion_getBounds(void *region); // (SkRegion *region) -> const SkIRect *
        func computeRegionComplexity() -> Int // int SkRegion_computeRegionComplexity(void *region); // (SkRegion *region) -> int
        func getBoundaryPath(path: SkPath) -> Bool // bool SkRegion_getBoundaryPath(void *region, void *path); // (SkRegion *region, SkPath *path) -> bool
        func setEmpty() -> Bool // bool SkRegion_setEmpty(void *region); // (SkRegion *region) -> bool
        func setRect(rect: SkIRect) -> Bool // bool SkRegion_setRect(void *region, const void *rect); // (SkRegion *region, const SkIRect *rect) -> bool
        func setRects(rects: [SkIRect]) -> Bool // bool SkRegion_setRects(void *region, const void * rects, int count); // (SkRegion *region, const SkIRect rects[], int count) -> bool
        ...
        func setPath(path: SkPath, clip: SkRegion) -> Bool // bool SkRegion_setPath(void *region, const void *path, const void *clip); // (SkRegion *region, const SkPath *path, const SkRegion *clip) -> bool
        func intersects(rect: SkIRect) -> Bool // bool SkRegion_intersects(void *region, const void *rect); // (SkRegion *region, const SkIRect *rect) -> bool
        ...
        func contains(other: SkIRect) -> Bool // bool SkRegion_contains_2(void *region, const void *other); // (SkRegion *region, const SkIRect *other) -> bool
        ...
        func quickContains(r: SkIRect) -> Bool // bool SkRegion_quickContains(void *region, const void *r); // (SkRegion *region, const SkIRect *r) -> bool
        func quickReject(rect: SkIRect) -> Bool // bool SkRegion_quickReject(void *region, const void *rect); // (SkRegion *region, const SkIRect *rect) -> bool
        ...
        func op(rect: SkIRect, op: Int) -> Bool // bool SkRegion_op(void *region, const void *rect, int op); // (SkRegion *region, const SkIRect *rect, SkRegion::Op op) -> bool
        ...
        func op(rect: SkIRect, rgn: SkRegion, op: Int) -> Bool // bool SkRegion_op_3(void *region, const void *rect, const void *rgn, int op); // (SkRegion *region, const SkIRect *rect, const SkRegion *rgn, SkRegion::Op op) -> bool
        func op(rgn: SkRegion, rect: SkIRect, op: Int) -> Bool // bool SkRegion_op_4(void *region, const void *rgn, const void *rect, int op); // (SkRegion *region, const SkRegion *rgn, const SkIRect *rect, SkRegion::Op op) -> bool
    ...
    class SkRegion : SkRegionProtocol {
        public var pointer: SkRegionMutablePointer?
        ...
        required init(pointer: SkRegionMutablePointer?, handle: sk_region_t) {
        ...
        func getBounds() -> SkIRect {
            let pointer = SkRegion_getBounds(self.pointer)
            return SkIRect(pointer: UnsafeMutableRawPointer(mutating: pointer), handle: -1)
        }
        ...
        func getBoundaryPath(path: SkPath) -> Bool {
        ...
        func setRect(rect: SkIRect) -> Bool {
            return SkRegion_setRect(self.pointer, rect.pointer)
        }

        func setRects(rects: [SkIRect]) -> Bool {
        ...
        func setPath(path: SkPath, clip: SkRegion) -> Bool {
            return SkRegion_setPath(self.pointer, path.pointer, clip.pointer)
        }

        func intersects(rect: SkIRect) -> Bool {
        ...
        func contains(other: SkIRect) -> Bool {
        ...
        func quickContains(r: SkIRect) -> Bool {
            return SkRegion_quickContains(self.pointer, r.pointer)
        }

        func quickReject(rect: SkIRect) -> Bool {
        ...
        func op(rect: SkIRect, op: Int) -> Bool {
        ...
        func op(rect: SkIRect, rgn: SkRegion, op: Int) -> Bool {
            return SkRegion_op_3(self.pointer, rect.pointer, rgn.pointer, Int32(op))
        }

        func op(rgn: SkRegion, rect: SkIRect, op: Int) -> Bool {
