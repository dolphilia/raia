extension Skia {
    protocol SkSurfacePropsProtocol {
        ...
        func cloneWithPixelGeometry(newPixelGeometry: SkPixelGeometry) -> SkSurfaceProps // int SkSurfaceProps_cloneWithPixelGeometry(void *surface_props, int newPixelGeometry); // (SkSurfaceProps *surface_props, SkPixelGeometry newPixelGeometry) -> sk_surface_props_t
        func flags() -> UInt // unsigned int SkSurfaceProps_flags(void *surface_props); // (SkSurfaceProps *surface_props) -> uint32_t
        func pixelGeometry() -> SkPixelGeometry // int SkSurfaceProps_pixelGeometry(void *surface_props); // (SkSurfaceProps *surface_props) -> SkPixelGeometry
    ...
    class SkSurfaceProps: SkSurfacePropsProtocol {
        ...
        required init(flags: UInt, geometry: SkPixelGeometry) {
        ...
        func cloneWithPixelGeometry(newPixelGeometry: SkPixelGeometry) -> SkSurfaceProps {
        ...
        func pixelGeometry() -> SkPixelGeometry {
            return SkPixelGeometry(rawValue: Int32(SkSurfaceProps_pixelGeometry(self.pointer)))!
        }
