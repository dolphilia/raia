extension Skia {
    class SkMatrix {
        ...
        public var pointer: Skia.SkMatrixMutablePointer?
        ...
        init(pointer: Skia.SkMatrixMutablePointer?, handle: sk_matrix_t) {
        ...
        static func Translate(t: IPoint) -> SkMatrix {
        ...
        static func RectToRect(src: SkRect, dst: SkRect, mode: ScaleToFit) -> SkMatrix {
        ...
        static func MakeRectToRect(src: SkRect, dst: SkRect, stf: ScaleToFit) -> SkMatrix {
        ...
        func mapPoints(dst: [SkPoint], src: [SkPoint], count: Int) {
        ...
        func mapPoints(pts: [SkPoint], count: Int) {
        ...
        func mapHomogeneousPoints(dst: [SkPoint3], src: [SkPoint], count: Int) {
        ...
        func mapVectors(dst: [SkVector], src: [SkVector], count: Int) {
        ...
        func mapVectors(vecs: [SkVector], count: Int) {
        ...
        func mapRectToQuad(dst: [SkPoint], rect: SkRect) {
        ...
        func getMinMaxScales(scaleFactors: [Float]) -> Bool {
