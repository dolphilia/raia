extension Skia {
    class ColorInfo {
        ...
        init(ct: SkColorType, at: SkAlphaType, colorSpace: ColorSpace) {
        ...
        func makeAlphaType(newAlphaType: SkAlphaType) -> ColorInfo {
        ...
        func makeColorType(newColorType: SkColorType) -> ColorInfo {
