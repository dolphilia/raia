...
extern "C" RAIA_EXPORT const char* raia_imgui_impl_opengl3_new_frame(const char *s) {
    ImGui_ImplOpenGL3_NewFrame();
    return nullptr;
}

extern "C" RAIA_EXPORT const char* raia_imgui_impl_glfw_new_frame(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_new_frame(const char *s) {
    raia_gui_new_frame();
    return nullptr;
}
...
extern "C" RAIA_EXPORT const char* raia_imgui_check_version(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_create_context(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_set_config_flags(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_config_viewports_no_auto_merge(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    int flag = joint_get_in_bool(joint, "flag");
...
extern "C" RAIA_EXPORT const char* raia_imgui_config_viewports_no_task_bar_icon(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    int flag = joint_get_in_bool(joint, "flag");
...
extern "C" RAIA_EXPORT const char* raia_imgui_font_global_scale(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    double num = joint_get_in_int_or_real(joint, "num");
    _raia_imgui_font_global_scale((float)num);
    joint_free(joint);
    return nullptr;
}
...
extern "C" RAIA_EXPORT const char* raia_imgui_get_framerate(const char *s) {
...
extern "C" RAIA_EXPORT const char *raia_imgui_style_colors_dark(const char *s) {
...
extern "C" RAIA_EXPORT const char *raia_imgui_style_colors_light(const char *s) {
...
extern "C" RAIA_EXPORT const char *raia_imgui_style_colors_classic(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_set_style_window_border_size(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    double num = joint_get_in_int_or_real(joint, "num");
    _raia_imgui_set_style_window_border_size((float)num);
    joint_free(joint);
    return nullptr;
}
...
extern "C" RAIA_EXPORT const char* raia_imgui_set_style_window_rounding(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    double num = joint_get_in_int_or_real(joint, "num");
    _raia_imgui_set_style_window_rounding((float)num);
    joint_free(joint);
    return nullptr;
}
...
extern "C" RAIA_EXPORT const char* raia_imgui_set_style_scale_all_sizes(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    double num = joint_get_in_int_or_real(joint, "num");
    _raia_imgui_set_style_scale_all_sizes((float)num);
    joint_free(joint);
    return nullptr;
}
...
extern "C" RAIA_EXPORT const char* raia_imgui_set_style_colors(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_impl_glfw_init_for_opengl(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_impl_opengl3_init(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_add_font_default(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_get_glyph_ranges_japanese(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_add_font_from_file_ttf(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_assert(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_set_font_default(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_impl_opengl3_shutdown(const char *s) {
    ImGui_ImplOpenGL3_Shutdown();
    return nullptr;
}

extern "C" RAIA_EXPORT const char* raia_imgui_impl_glfw_shutdown(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_destroy_context(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_render(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_get_draw_data(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_impl_opengl3_render_draw_data(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_update_platform_windows(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_render_platform_windows_default(const char *s) {
...
extern "C" RAIA_EXPORT const char* raia_imgui_begin(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_end(const char *s) {
    _raia_gui_imgui_end();
    return nullptr;
}
...
extern "C" RAIA_EXPORT const char* raia_imgui_text(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_button(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_image(const char *s) {
    joint_t *joint = joint_init_with_str(s);
...
extern "C" RAIA_EXPORT const char* raia_imgui_checkbox(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    const char *label = joint_get_in_str(joint, "label");
...
extern "C" RAIA_EXPORT const char* raia_imgui_slider_float(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    const char *label = joint_get_in_str(joint, "label");
...
extern "C" RAIA_EXPORT const char* raia_imgui_color_edit_3(const char *s) {
    joint_t *joint = joint_init_with_str(s);
    const char *label = joint_get_in_str(joint, "label");
    double red = joint_get_in_int_or_real(joint, "red");
    double green = joint_get_in_int_or_real(joint, "green");
...
extern "C" RAIA_EXPORT const char* raia_imgui_same_line(const char *s) {
