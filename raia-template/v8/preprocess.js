...
//
 ...
 var raia_preprocess_handle = __Raia__.Lib.open("raia_file");
 __Raia__.Lib.add(raia_preprocess_handle, "raia_file_exist");
 __Raia__.Lib.add(raia_preprocess_handle, "raia_file_get_dirs");
 __Raia__.Lib.add(raia_preprocess_handle, "raia_file_get_cur_path");
 __Raia__.Lib.add(raia_preprocess_handle, "raia_file_load_string");
 __Raia__.Lib.add(raia_preprocess_handle, "raia_file_save_string");
...
(function () {
    var getDirs = function(path) {
        return JSON.parse(__Raia__.Lib.call("raia_file_get_dirs", JSON.stringify({"path": path, "@return": "string"}))).result;
    };
    ...
    var getCurPath = function() {
        return JSON.parse(__Raia__.Lib.call("raia_file_get_cur_path", JSON.stringify({"@return": "string"}))).result;
    };
    __Raia__.allDirs = getAllDirs(getCurPath()+"/modules");
    __Raia__.allDirs.unshift('.');
    __Raia__.allDirs.unshift(getCurPath());
}());

var modSearch = function (path) {
...
(function () {
    ...
    var loadString = function(path) {
        return JSON.parse(__Raia__.Lib.call("raia_file_load_string", JSON.stringify({"path": path, "@return": "string"}))).result;
    };
    var saveString = function(path, data) {
        return JSON.parse(__Raia__.Lib.call("raia_file_save_string", JSON.stringify({"path": path, "data": data, "@return": "string"}))).result;
    };
